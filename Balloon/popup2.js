...
*/
//ここからバナー
function banner2(title,text,detail = text){
    var div = document.createElement('div');
    div.className = "banner2";
    div.setAttribute("onclick","this.style.animation='animation-banner-up 0.5s';showAlert2('"+title+"','"+detail+"','noClose')");
  ...
  //ここからアラート
  function showAlert2(title,txt,popup="hidden",fn=function(){}){
    //タイトル、本文、(デフォルト=10秒閉じ,noClose=自動で閉じないアラート,その他＝confirm),関数ー＞""で囲む,Okayに渡される
    var div1 = document.createElement('div');
    div1.className = "bgAlert2";
  ...
  function hideConfirm2(obj,fc=function(){}){
